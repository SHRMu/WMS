...
public class PacketStorageManageHandler {
     ...
     */
    private Map<String, Object> query(String searchType, String keyword, Integer repositoryID,
        ...
        switch (searchType) {
            case SEARCH_BY_PACKET_ID:
                if (StringUtils.isNumeric(keyword)) {
                    ...
                    queryResult = packetStorageManageService.selectByID(-1, packetID, repositoryID);
                }
                break;
            case SEARCH_BY_TRACE:
                queryResult = packetStorageManageService.selectApproximate(keyword, "", repositoryID);
                break;
            case SEARCH_ACTIVE:
                queryResult = packetStorageManageService.selectApproximate("", StatusUtil.PACKET_STATUS_SEND,repositoryID);
                break;
            case SEARCH_ALL:
                queryResult = packetStorageManageService.selectAll(repositoryID);
                break;
            default:
                break;
        }
    ...
    public
    @ResponseBody
    Map<String, Object> getStorageListWithPacket(@RequestParam("searchType") String searchType,
