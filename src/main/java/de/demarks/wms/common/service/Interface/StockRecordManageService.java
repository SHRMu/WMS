...
public interface StockRecordManageService {
     ...
     */
    boolean stockInOperation(String packet, Integer batch, Integer customerID, Integer goodsID, Integer repositoryID, long number, String personInCharge) throws StockRecordManageServiceException;
     ...
     */
    boolean stockOutOperation(String packet, Integer batch, Integer customerID, Integer goodsID, Integer repositoryID, long number, String personInCharge) throws StockRecordManageServiceException;
