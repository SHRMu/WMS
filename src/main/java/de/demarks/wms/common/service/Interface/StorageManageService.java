...
public interface StorageManageService {
     ...
     * 返回指定批次ID的库存记录
     *
     * @param batchID 指定的货物类型
     * @return 结果的一个Map，其中： key为 data 的代表记录数据；key 为 total 代表结果记录的数量
     */
    Map<String, Object> selectByBatchID(Integer batchID, Integer Repository) throws StorageManageServiceException;
     ...
     * @return 结果的一个Map，其中： key为 data 的代表记录数据；key 为 total 代表结果记录的数量
     */
    Map<String, Object> selectByBatchID(Integer batchID, Integer repositoryID, int offset, int limit) throws StorageManageServiceException;

    /**
     * 返回指定批次数的库存记录
     *
     * @param batchCode 指定的批次编号
     * @return 结果的一个Map，其中： key为 data 的代表记录数据；key 为 total 代表结果记录的数量
     */
    Map<String, Object> selectByBatchCode(String batchCode, Integer Repository) throws StorageManageServiceException;
     ...
     * @return 结果的一个Map，其中： key为 data 的代表记录数据；key 为 total 代表结果记录的数量
     */
    Map<String, Object> selectByBatchCode(String batchCode, Integer repositoryID, int offset, int limit) throws StorageManageServiceException;
     ...
     */
    boolean addNewStorage(Integer goodsID, Integer batchID, Integer repositoryID, long number) throws StorageManageServiceException;
